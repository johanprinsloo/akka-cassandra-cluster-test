...
function parseValue(val, parent, level, theme, enableHeader)
{
   elementCount++;
...
function hideChild(ele)
{
   ...
   for(i = 0; i < nodes.length; i++)
   {
      if(nodes[i].tagName == "TABLE")
      {
         ...
         ele.src = (minimizing ? "/img/max.gif" : "/img/min.gif");
